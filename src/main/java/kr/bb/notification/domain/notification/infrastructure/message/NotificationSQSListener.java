...
import kr.bb.notification.common.dto.ResaleNotifiatoiinDtoList;
...
public class NotificationSQSListener {
  ...
  public void consumeProductResaleNotificationCheckQueue(
    ...
    ResaleNotifiatoiinDtoList restoreNotification =
        objectMapper.readValue(message, ResaleNotifiatoiinDtoList.class);
